...
public class ReplyController {
	...
	public ResponseEntity<String> create(@RequestBody ReplyVO reply) {
		...
		return service.regist(reply)? new ResponseEntity<String>("success", HttpStatus.OK) :
	...
	public ResponseEntity<String> update(@PathVariable("rno") int rno, @RequestBody ReplyVO reply) {
		log.info("댓글수정...");
		reply.setRno(rno);
		return service.update(reply)? new ResponseEntity<String>("success", HttpStatus.OK) :
			new ResponseEntity<String>("fail", HttpStatus.INTERNAL_SERVER_ERROR);
	}
	...
	public ResponseEntity<String> remove(@PathVariable("rno") int rno){
		log.info("댓글 삭제..."+rno);
		return service.delete(rno)? new ResponseEntity<String>("success", HttpStatus.OK) :
			new ResponseEntity<String>("fail", HttpStatus.INTERNAL_SERVER_ERROR);
	}
}
