...
@RestController  //리턴하는 모든 값들은 실체값 (jsp 페이지 개념 X)
@Slf4j
public class RestControllerTest {
	
	@GetMapping(value="/hello", produces = "text/plain;charset=ISO-8859-1") //produces 보내려는 값의 형태
	...
	@GetMapping("/product/{cat}/{pid}") // http://localhost:8081/product/bags/1234
	public String[] getPath(@PathVariable("cat") String cat,@PathVariable("pid") String pid) {
		return new String[] {"catrgory : "+cat, "product : "+pid};
	}
